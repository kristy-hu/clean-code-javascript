...
> author: [@ryanmcdermott](https://github.com/ryanmcdermott/clean-code-javascript) | translator: [@stackNavigator](https://github.com/stackNavigator/clean-code-javascript-ua)
