...
> author: [@ryanmcdermott](https://github.com/ryanmcdermott/clean-code-javascript) | translator: [@felipe-augusto](https://github.com/felipe-augusto/clean-code-javascript)
...
adaptados para JavaScript. Isto não é um guia de estilos. É um guia para se produzir código [legível, reutilizável e refatorável](/3rs-of-software-architecture.md) [(original)](https://github.com/ryanmcdermott/3rs-of-software-architecture) em JavaScript.
